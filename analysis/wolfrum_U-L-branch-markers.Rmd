...
plot_featureplots <- function(data, markergenes, dir, branch){
  ...
  #pdf
  save_plot(paste(dir, 'markers_', branch, '_1-28.pdf', sep=''), grid_1, base_height=40, base_width=9)
  save_plot(paste(dir, 'markers_', branch, '_29-56.pdf', sep=''), grid_2, base_height=40, base_width=9)
  
  #png
    save_plot(paste(dir, 'markers_', branch, '_1-28.png', sep=''), grid_1, base_height=40, base_width=9)
  save_plot(paste(dir, 'markers_', branch, '_29-56.png', sep=''), grid_2, base_height=40, base_width=9)
...
```{r, fig.height = 40, fig.width = 9, fig.align = "center"}
grids[[1]]
```
