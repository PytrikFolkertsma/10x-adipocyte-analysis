...
grids <- plot_featureplots(vijay, markergenes=markers_u, dir='/projects/pytrik/sc_adipose/analyze_10x_fluidigm/10x-adipocyte-analysis/figures/figures_paper/supplementary_figures/vijay/u_l_branch_markers/all_data/', branch='U_branch')
```

```{r}
TSNEPlot(vijay, features='celltype', label=T)
```
