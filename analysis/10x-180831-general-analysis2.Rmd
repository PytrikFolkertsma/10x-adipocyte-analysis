...
#After demuxlet results

```{r fig10, fig.height = 5, fig.width = 6, fig.align = "center"}
TSNEPlot(seurobj, colors.use=c("#845d1e", "#edd2a8", "#5e3720", '#ecb66b'), group.by='depot', pt.size = 0.1)
```
