...
```{r, fig.height = 4, fig.width = 8.5, fig.align = "center"}
pparg <- FeaturePlot(data.180831, features='PPARG', pt.size=0.5) + NoLegend() + NoAxes() + theme(plot.title = element_text(size=20)) + scale_color_gradient(name='Expression', low='gray', high='blue', guide='colorbar', limits=c(0,2.5))

ebf2 <- FeaturePlot(data.180831, features='EBF2', pt.size=0.5) + NoAxes() + theme(plot.title = element_text(size=20), legend.text=element_text(size=15), legend.key.height = unit(1.3, 'cm')) + scale_color_gradient(name='Expression', low='gray', high='blue', guide='colorbar', limits=c(0,2.5)) 
