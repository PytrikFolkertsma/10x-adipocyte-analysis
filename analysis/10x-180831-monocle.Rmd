...
#branched_8_0.3 <- plot_genes_branched_heatmap(cds[row.names(subset(BEAM_signficnat_res, abs(avgLogFC_State2_State3) > 0.3))],
#                                         branch_point = 1,
#                                         num_clusters = 8,
#                                         cores = 10,
#                                         show_rownames = T,
...
Different number of clusters for logFC > 0.3.
