...
write.table(markers_1, '../output/markergenes/180831/markers_10x-180831-T1T2T3_res.1.5_negbinom', sep='\t', row.names=F, quote=F)
write.table(markers_2, '../output/markergenes/180831/markers_10x-180831-T4T5_res.1.5_negbinom', sep='\t', row.names=F, quote=F)
...
write.table(genes, file='../output/markergenes/180831/10x-180831_genelist_T1T2T3-T4T5_res.1.5', sep='\n', row.names=F, quote=F, header=F)
